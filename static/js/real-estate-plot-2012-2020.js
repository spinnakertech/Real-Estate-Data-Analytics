...
console.log("real estate 2012-2020: starting code . . .");

function filterhomesalesUS(realestateSales) {
    return realestateSales.state_code === "US" && realestateSales.year >= 2012;
}

console.log("real estate 2012-2020: function defined . . .");
...
// Define the plot layout
    var layout = {
      title: "Real Estate Sales Data 2012-2020 (Year-over-Year Changes)",
      xaxis: { title: "Date" },
      yaxis: { title: "Sales Volume"}
    };
  
// Plot the chart to a div tag with id "real-estate-line-plot"
    Plotly.newPlot("real-estate-all-line-plot-2012-2020", data, layout);
